# Upstream README history (arch1t3cht & TypesettingTools)

> This file preserves the original README content from the upstream lineage this
> fork is built on — **arch1t3cht's Aegisub fork** and, below it, the
> **TypesettingTools / Aegisub** project README. It is kept verbatim for
> attribution and historical reference. The current project README is
> [`../README.md`](../README.md).
